                ...
                children: [
                              ...
                              children: [
                                Expanded(
                                  child: ElevatedButton.icon(
                                    onPressed: () async {
                                      final trailerKey =
                                          await TMDBService.getTVShowTrailerKey(
                                            tvShow.id,
                                          );
                                ...
                                IconButton(
                                  onPressed: () async {
                                    final isFavorite = await favorites_service
                                        .FavoritesService.isFavorite(tvShow.id);
                                    if (isFavorite) {
                  ...
                  if (tvShow.genreIds.isNotEmpty) ...[
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: tvShow.genreIds.take(5).map((genreId) {
                        return Container(
                          padding: const EdgeInsets.symmetric(
                            horizontal: 12,
                            vertical: 6,
                  ...
                  const SizedBox(height: 16),
                  _buildInfoRow('TV Show ID', tvShow.id.toString()),
                  _buildInfoRow(
                    'Rating',
                    '${tvShow.voteAverage.toStringAsFixed(1)}/10',
                  ),
